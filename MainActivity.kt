...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            var conn = ConexionSQL(this, nombreBD,null,1)
            conn.insertarCategoria(cate1)
            conn.insertarCategoria(cate2)
            conn.insertarCategoria(cate3)
            var prove = Proveedor(1,"Spagetti","Benjamin", "1001-1","98882992","benja@spagetti.cl", Calendar.getInstance().toString(),1)
